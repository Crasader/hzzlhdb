...
namespace ddz
{
	...
	//			{
	//				sprintf(temp, "Resources/cards/card_%02d.png", card_data_[index] == 0x4E ? 53 : 54);
	//			}
	//			else
	//			{
	//				sprintf(temp, "Resources/cards/card_%02d.png", (card_data_[index] & MASK_VALUE) + ((card_data_[index] & MASK_COLOR) >> 4) * 13);
	//			}
